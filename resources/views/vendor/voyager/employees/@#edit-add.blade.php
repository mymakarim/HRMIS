            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <!-- yahya - use this -->
                            @include('voyager::multilingual.input-hidden', [
                                '_field_name'  => 'bio',
                                '_field_trans' => get_field_translations($dataTypeContent, 'bio')
                            ])
                            @php
                                $dataTypeRows = $dataType->{($edit ? 'editRows' : 'addRows' )};
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> Salary Section </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        @include('voyager::multilingual.input-hidden', [
                            '_field_name'  => 'salary',
                            '_field_trans' => get_field_translations($dataTypeContent, 'salary')
                        ])
                        @php
                            $dataTypeRows = $dataType->{($edit ? 'editRows' : 'addRows' )};
